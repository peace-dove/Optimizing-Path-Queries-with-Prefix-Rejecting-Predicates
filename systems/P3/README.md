...
**Example - FinBench Q1/TCR1 on SF10:**
```bash
cd /home/{USER}/data_universe/build/output/bin/test/tp_instance_test
./tp_instance_test \
...
- `FinTest1BatchId` / `FinTest1BatchIdwoopt` - Q1/TCR1
- `FinTest2BatchId` / `FinTest2BatchIdwoopt` - Q2/TCR2
- `FinTest5BatchId` / `FinTest5BatchIdwoopt` - Q3/TCR5
- `FinTest11BatchId` / `FinTest11BatchIdwoopt` - Q4/TCR11

> Remark: Q1–Q4 are adapted from LDBC FinBench TCR1, TCR2, TCR5, TCR11 respectively. See [`queries/FinBench/README.md`](../../queries/FinBench/README.md) for the full mapping.
